...
int main()
{
    ...
    cout << "Hello WinSock! Type messages to send to server. Type 'exit' or 'quit' to disconnect." << endl;
    ...
    do
    {
        ...
        strncpy_s(send_buffer, userInput.c_str(), BUFFER_LENGTH - 1);
        send_buffer[BUFFER_LENGTH - 1] = '\0'; 
